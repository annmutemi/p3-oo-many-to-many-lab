...
def test_contract_contracts_by_date():
    ...
    Contract.all_contracts = []  # Clear any existing contracts
    ...
    # Create contracts with various dates
    ...
    # Check that contracts_by_date returns only contracts with the specified date
